...
class Postlink_Classroom {
	...
	private function define_public_hooks() {
		...
		// // Hook for loadmoredata show
		$this->loader->add_action("wp_ajax_loadmoredata", $plugin_public, "loadmoredata");
		$this->loader->add_action("wp_ajax_nopriv_loadmoredata", $plugin_public, "loadmoredata");
